...
# inmediatamente muestre su suma, resta, multiplicación y división. Hacer cada operación en otro 
# método de la clase Operación y llamarlos desde el mismo método __init__
